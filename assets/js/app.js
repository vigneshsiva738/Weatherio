...
/**
 * Add event listener on multiple elemnts
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
            ...
            <div class="weapper">
                ...
                <img src="./assets/images/weather_icons/${icon}.png" alt="${description}" width="64" height="64" class="weather-icon" title="${description}">
            </div>
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <div class="card card-sm slider-card">
                    <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                    <img src="./assets/images/weather_icons/direction.png" alt="Direction" class="weather-icon" width="48" height="48" loading="lazy" style="transform: rotate(${windDirection - 180}deg)" title="Wind Speed : ${parseInt(module.mps_to_kmh(windSpeed))} km/h | Wind Direction : ${windDirection}&deg;">
